...
This is triage, not parsing. Nothing here produces a canonical `Table`, `Node` or `Rate`; it classifies each loot source by how much machinery it will need.

## Pages to loot sources
...
| Loot source | Drops page | Pages | In scope |
|---|---|---:|:-:|
...
## Tier distribution across loot sources
...
| Chambers of Xeric | 51 | 33 |  |  | 33/33 sums exactly; 33 rows declare rolls > 1 |
| Chest (Barrows) | 34 | 2448 |  |  | 24/2448, shortfall 2424 is implicit nothing; 33 rows declare rolls > 1 |
...
| Lunar Chest | 24 | 30 |  |  | 30/30 sums exactly; 12 rows declare rolls > 1 |
...
| Reward Cart | 75 | 150 |  |  | rarity strings that are not fractions: Varies |
...
| Burnt chest | 1 | — |  |  | 1 rows, all Always — no weighted table on this page |
