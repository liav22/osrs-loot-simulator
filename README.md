...
Snapshot of the committed dataset, checked **2026-09-20**:
...
| **Total included** | **111** | Loot sources selected for coverage |
...
search hides. Of the **81 repeatable sources**, 66 pass validation: 50
